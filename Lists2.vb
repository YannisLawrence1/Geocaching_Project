...
Public Class Lists2
    ...
    Dim storedGeocacheNumber As String
    ...
    Private Sub Lists2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For position = 0 To MaxRows6 - 1
            If ListName = ds6.Tables("tblList").Rows(position).Item(1) Then
    ...
    Sub LoadGeocache2()
        ...
        Else
            MsgBox("No Caches are in this list")
            Lists.Show()
            Me.Close()
        End If
    ...
    Private Sub but5R_Click(sender As Object, e As EventArgs) Handles but5R.Click
        If position < MaxRows8 - 9 Then
            position = position + 5
            geocacheUpdate()

        ElseIf position + 4 < MaxRows8 - 1 Then
            position = MaxRows8 - 5
            geocacheUpdate()
        Else
    ...
    Private Sub butSearch_Click(sender As Object, e As EventArgs) Handles butSearch.Click
        If radGeocacheNumber.Checked = True Then
            For x = 0 To MaxRows8 - 1
                If txtSearch.Text = ds8.Tables("tblGeocache2").Rows(x).Item(0) Then
                    position = x
                    geocacheUpdate()
                    found = True
                    Exit For
        ...
        ElseIf radChurchMicro.Checked = True Then
            For x = 0 To MaxRows8 - 1
                If txtSearch.Text = ds8.Tables("tblGeocache2").Rows(x).Item(1) Then
                    position = x
                    geocacheUpdate()
                    found = True
                    Exit For
        ...
        ElseIf radCacheName.Checked = True Then
            For x = 0 To MaxRows8 - 1
                If txtSearch.Text = ds8.Tables("tblGeocache2").Rows(x).Item(2) Then
                    position = x
                    geocacheUpdate()
                    found = True
                    Exit For
    ...
    Sub geocacheUpdate()
        ...
        txtPosition.Text = (position + 5 & "/" & MaxRows8)



        If MaxRows8 > position Then
            txtGeocacheNumber1.Text = ds8.Tables("tblGeocache2").Rows(position).Item(0)

            txtChurchMicroNumber1.Text = ds8.Tables("tblGeocache2").Rows(position).Item(1)

            txtCacheTitle1.Text = ds8.Tables("tblGeocache2").Rows(position).Item(2)

            '----------------------------------------------------------------------------------------------------------------------------
            cacheTypeDetails = ds8.Tables("tblGeocache2").Rows(position).Item(3)
            For w = 1 To MaxRows3
            ...
            w = 1
            '----------------------------------------------------------------------------------------------------------------------------
            containnerTypeDetails = ds8.Tables("tblGeocache2").Rows(position).Item(4)
            For w = 1 To MaxRows4
            ...
            w = 1
            '----------------------------------------------------------------------------------------------------------------------------
            txtTerrainRaiting1.Text = ds8.Tables("tblGeocache2").Rows(position).Item(5) & " / " & ds8.Tables("tblGeocache2").Rows(position).Item(12)

            txtNorth1.Text = ds8.Tables("tblGeocache2").Rows(position).Item(6)

            txtWest1.Text = ds8.Tables("tblGeocache2").Rows(position).Item(7)
            '----------------------------------------------------------------------------------------------------------------------------
            countyDetails = ds8.Tables("tblGeocache2").Rows(position).Item(8)
            For w = 1 To MaxRows5
            ...
            w = 1
            '----------------------------------------------------------------------------------------------------------------------------
            userDetails = ds8.Tables("tblGeocache2").Rows(position).Item(10)
            For w = 1 To MaxRows
            ...
            If MaxRows8 > position + 1 Then

                txtGeocacheNumber2.Text = ds8.Tables("tblGeocache2").Rows(position + 1).Item(0)

                txtChurchMicroNumber2.Text = ds8.Tables("tblGeocache2").Rows(position + 1).Item(1)

                txtCacheTitle2.Text = ds8.Tables("tblGeocache2").Rows(position + 1).Item(2)

                '----------------------------------------------------------------------------------------------------------------------------
                cacheTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 1).Item(3)
                For w = 1 To MaxRows3
                    If inc <> MaxRows3 - 1 Then
                ...
                w = 1
                '----------------------------------------------------------------------------------------------------------------------------
                containnerTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 1).Item(4)
                For w = 1 To MaxRows4
                    If inc <> MaxRows4 - 1 Then
                ...
                w = 1
                '----------------------------------------------------------------------------------------------------------------------------
                txtTerrainRaiting2.Text = ds8.Tables("tblGeocache2").Rows(position + 1).Item(5) & " / " & ds8.Tables("tblGeocache2").Rows(position + 1).Item(12)

                txtNorth2.Text = ds8.Tables("tblGeocache2").Rows(position + 1).Item(6)

                txtWest2.Text = ds8.Tables("tblGeocache2").Rows(position + 1).Item(7)
                '----------------------------------------------------------------------------------------------------------------------------
                countyDetails = ds8.Tables("tblGeocache2").Rows(position + 1).Item(8)
                For w = 1 To MaxRows5
                    If inc <> MaxRows5 - 1 Then
                ...
                w = 1
                '----------------------------------------------------------------------------------------------------------------------------
                userDetails = ds8.Tables("tblGeocache2").Rows(position + 1).Item(10)
                For w = 1 To MaxRows
                    If inc <> MaxRows - 1 Then
                ...
                If MaxRows8 > position + 2 Then

                    txtGeocacheNumber3.Text = ds8.Tables("tblGeocache2").Rows(position + 2).Item(0)

                    txtChurchMicroNumber3.Text = ds8.Tables("tblGeocache2").Rows(position + 2).Item(1)

                    txtCacheTitle3.Text = ds8.Tables("tblGeocache2").Rows(position + 2).Item(2)

                    '----------------------------------------------------------------------------------------------------------------------------
                    cacheTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 2).Item(3)
                    For w = 1 To MaxRows3
                        If inc <> MaxRows3 - 1 Then
                    ...
                    w = 1
                    '----------------------------------------------------------------------------------------------------------------------------
                    containnerTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 2).Item(4)
                    For w = 1 To MaxRows4
                        If inc <> MaxRows4 - 1 Then
                    ...
                    w = 1
                    '----------------------------------------------------------------------------------------------------------------------------
                    txtTerrainRaiting3.Text = ds8.Tables("tblGeocache2").Rows(position + 2).Item(5) & " / " & ds8.Tables("tblGeocache2").Rows(position + 2).Item(12)

                    txtNorth3.Text = ds8.Tables("tblGeocache2").Rows(position + 2).Item(6)

                    txtWest3.Text = ds8.Tables("tblGeocache2").Rows(position + 2).Item(7)
                    '----------------------------------------------------------------------------------------------------------------------------
                    countyDetails = ds8.Tables("tblGeocache2").Rows(position + 2).Item(8)
                    For w = 1 To MaxRows5
                        If inc <> MaxRows5 - 1 Then
                    ...
                    w = 1
                    '----------------------------------------------------------------------------------------------------------------------------
                    userDetails = ds8.Tables("tblGeocache2").Rows(position + 2).Item(10)
                    For w = 1 To MaxRows
                        If inc <> MaxRows - 1 Then
                    ...
                    If MaxRows8 > position + 3 Then

                        txtGeocacheNumber4.Text = ds8.Tables("tblGeocache2").Rows(position + 3).Item(0)

                        txtChurchMicroNumber4.Text = ds8.Tables("tblGeocache2").Rows(position + 3).Item(1)

                        txtCacheTitle4.Text = ds8.Tables("tblGeocache2").Rows(position + 3).Item(2)

                        '----------------------------------------------------------------------------------------------------------------------------
                        cacheTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 3).Item(3)
                        For w = 1 To MaxRows3
                            If inc <> MaxRows3 - 1 Then
                        ...
                        w = 1
                        '----------------------------------------------------------------------------------------------------------------------------
                        containnerTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 3).Item(4)
                        For w = 1 To MaxRows4
                            If inc <> MaxRows4 - 1 Then
                        ...
                        w = 1
                        '----------------------------------------------------------------------------------------------------------------------------
                        txtTerrainRaiting4.Text = ds8.Tables("tblGeocache2").Rows(position + 3).Item(5) & " / " & ds8.Tables("tblGeocache2").Rows(position + 3).Item(12)

                        txtNorth4.Text = ds8.Tables("tblGeocache2").Rows(position + 3).Item(6)

                        txtWest4.Text = ds8.Tables("tblGeocache2").Rows(position + 3).Item(7)
                        '----------------------------------------------------------------------------------------------------------------------------
                        countyDetails = ds8.Tables("tblGeocache2").Rows(position + 3).Item(8)
                        For w = 1 To MaxRows5
                            If inc <> MaxRows5 - 1 Then
                        ...
                        w = 1
                        '----------------------------------------------------------------------------------------------------------------------------
                        userDetails = ds8.Tables("tblGeocache2").Rows(position + 3).Item(10)
                        For w = 1 To MaxRows
                            If inc <> MaxRows - 1 Then
                        ...
                        If MaxRows8 > position + 4 Then

                            txtGeocacheNumber5.Text = ds8.Tables("tblGeocache2").Rows(position + 4).Item(0)

                            txtChurchMicroNumber5.Text = ds8.Tables("tblGeocache2").Rows(position + 4).Item(1)

                            txtCacheTitle5.Text = ds8.Tables("tblGeocache2").Rows(position + 4).Item(2)

                            '----------------------------------------------------------------------------------------------------------------------------
                            cacheTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 4).Item(3)
                            For w = 1 To MaxRows3
                                If inc <> MaxRows3 - 1 Then
                            ...
                            w = 1
                            '----------------------------------------------------------------------------------------------------------------------------
                            containnerTypeDetails = ds8.Tables("tblGeocache2").Rows(position + 4).Item(4)
                            For w = 1 To MaxRows4
                                If inc <> MaxRows4 - 1 Then
                            ...
                            w = 1
                            '----------------------------------------------------------------------------------------------------------------------------
                            txtTerrainRaiting5.Text = ds8.Tables("tblGeocache2").Rows(position + 4).Item(5) & " / " & ds8.Tables("tblGeocache2").Rows(position + 4).Item(12)

                            txtNorth5.Text = ds8.Tables("tblGeocache2").Rows(position + 4).Item(6)

                            txtWest5.Text = ds8.Tables("tblGeocache2").Rows(position + 4).Item(7)
                            '----------------------------------------------------------------------------------------------------------------------------
                            countyDetails = ds8.Tables("tblGeocache2").Rows(position + 4).Item(8)
                            For w = 1 To MaxRows5
                                If inc <> MaxRows5 - 1 Then
                            ...
                            w = 1
                            '----------------------------------------------------------------------------------------------------------------------------
                            userDetails = ds8.Tables("tblGeocache2").Rows(position + 4).Item(10)
                            For w = 1 To MaxRows
                                If inc <> MaxRows - 1 Then
                        ...
                        Else
                            ...
                            txtPosition.Text = (position + 4 & "/" & MaxRows8)
                    ...
                    Else
                        ...
                        txtWest5.Text = ("")
                        '----------------------------------------------------------------------------------------------------------------------------
                        txtPosition.Text = (position + 3 & "/" & MaxRows8)
                ...
                Else
                    ...
                    txtWest5.Text = ("")
                    '----------------------------------------------------------------------------------------------------------------------------
                    txtPosition.Text = (position + 2 & "/" & MaxRows8)
            ...
            Else
                ...
                txtWest5.Text = ("")
                '----------------------------------------------------------------------------------------------------------------------------
                txtPosition.Text = (position + 1 & "/" & MaxRows8)
    ...
    Private Sub butNotes1_Click(sender As Object, e As EventArgs) Handles butNotes1.Click
        MsgBox(ds8.Tables("tblGeocache2").Rows(position).Item(9))
    End Sub
    ...
    Private Sub butNotes2_Click(sender As Object, e As EventArgs) Handles butNotes2.Click
        ...
        Else
            MsgBox(ds8.Tables("tblGeocache2").Rows(position + 1).Item(9))
        End If
    End Sub
    ...
    Private Sub butNotes3_Click(sender As Object, e As EventArgs) Handles butNotes3.Click
        ...
        Else
            MsgBox(ds8.Tables("tblGeocache2").Rows(position + 2).Item(9))
        End If
    End Sub
    ...
    Private Sub butNotes4_Click(sender As Object, e As EventArgs) Handles butNotes4.Click
        ...
        Else
            MsgBox(ds8.Tables("tblGeocache2").Rows(position + 3).Item(9))
        End If
    End Sub
    ...
    Private Sub butView5_Click(sender As Object, e As EventArgs) Handles butView5.Click
        ...
        Else
            MsgBox(ds8.Tables("tblGeocache2").Rows(position + 4).Item(9))
        End If
    End Sub
    ...
    Private Sub generateMap()
        ...
        PrintLine(1, "</script>")
        '<!--Load the APpositionfrom the specified URL
        'The async attribute allows the browser to render the page while the APpositionloads
        ' The key parameter will contain your own APpositionkey (which Is Not needed for this tutorial)
    ...
    Private Sub butAllMap_Click(sender As Object, e As EventArgs) Handles butAllMap.Click
        ...
        For geoPosition = 0 To MaxRows8 - 1
            northArray = (ds8.Tables("tblGeocache2").Rows(geoPosition).Item(6)).ToCharArray
            lengthN = Len(ds8.Tables("tblGeocache2").Rows(geoPosition).Item(6))
            lengthW = Len(ds8.Tables("tblGeocache2").Rows(geoPosition).Item(7))
            westArray = (ds8.Tables("tblGeocache2").Rows(geoPosition).Item(7)).ToCharArray

            nStore = ds8.Tables("tblGeocache2").Rows(geoPosition).Item(6)
            wStore = ds8.Tables("tblGeocache2").Rows(geoPosition).Item(7)

            name = ds8.Tables("tblGeocache2").Rows(geoPosition).Item(2)
            ...
            typeStore = ds8.Tables("tblGeocache2").Rows(geoPosition).Item(3)
            ...
            northCheck()
            WestCheck()
            If geoPosition < MaxRows8 - 1 Then
                PrintLine(1, "['<span>Name: " & name & "<br>GC number: " & ds8.Tables("tblGeocache2").Rows(geoPosition).Item(0) & "<br>CM number: " & ds8.Tables("tblGeocache2").Rows(geoPosition).Item(1) & "<br>Cache type: " & type_ & "<br>Location: " & nStore & " , " & wStore & "', " & north & ", " & west & ", " & geoPosition + 1 & "],")
            Else
                PrintLine(1, "['<span>Name: " & name & "<br>GC number: " & ds8.Tables("tblGeocache2").Rows(geoPosition).Item(0) & "<br>CM number: " & ds8.Tables("tblGeocache2").Rows(geoPosition).Item(1) & "<br>Cache type: " & type_ & "<br>Location: " & nStore & " , " & wStore & "', " & north & ", " & west & ", " & geoPosition + 1 & "]")
            End If
        Next
